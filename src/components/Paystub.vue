    ...
    <table class="table is-striped">
      <thead>
        <tr>
          <th>Pilot</th>
          <th>Roles</th>
          <th class="is-hidden-mobile">Points</th>
          <th class="is-hidden-mobile">Percentage</th>
      ...
      <tbody>
        ...
        <tr v-for="pilot in pilots" v-if="pilots.length > 0">
          ...
          <td class="is-hidden-mobile">{{ getPoints(pilot) }}</td>
          <td class="is-hidden-mobile">{{ getPercent(pilot) }}</td>
